...
Qual tipo de necessidade você possui?`,
    ...
    messages.push({
      text: `Obrigado por compartilhar, Marcos 💚

Vou adaptar minhas respostas para você.`,
      type: "received"
    });
    ...
    if (text === "1") {
      ...
      messages.push({
        text: `A acessibilidade garante que todas as pessoas possam acessar ambientes com autonomia.
...
✅ Solução: Adaptar acessos com rampas, sinalização e estrutura acessível.`,
      type: "received"
    });
...
function showMenu() {
  messages.push({
    ...
    buttons: [
      ...
      { text: "📚 Saber sobre acessibilidade", value: "2" },
